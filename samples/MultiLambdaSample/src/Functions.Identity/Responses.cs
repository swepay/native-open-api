...
public sealed record InvalidCredentialsError(string Message);
public sealed record ValidationProblemError(string Field, string Message);
public sealed record LoginOptionsResponse(string[] Methods);
